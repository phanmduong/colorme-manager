...
import {Platform, Dimensions, ScrollView, TouchableOpacity, Alert} from 'react-native';
import {
    Container,
    Button,
    View,
                ...
                <Container>
                    <View style={styles.containerPicker}>
                        <CustomPicker
                            ...
                            onValueChange={(value) => {this.props.onSelectGenId(value.id)}}
                        />
                        <CustomPicker
                            options={baseOptions}
                            ...
                            onValueChange={(value) => {this.props.onSelectBaseId(value.id)}}
                        />
                    </View>
