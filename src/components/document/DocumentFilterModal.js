...
class DocumentFilterModal extends React.Component {
  ...
  applyFilter = () => {
    this.props.loadDocuments(this.props.selectedDepartmentId);
  };
          ...
          {!this.props.isLoadingDepartments ? (
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.filterTitle}>
                <Text style={{fontSize: 16}}>Bộ phận</Text>
                <CustomPicker
                  options={this.getSearchedResults(
                    this.getData(this.props.departments),
                  )}
                  ...
                  headerTemplate={() => this.renderPickerHeader('Chọn bộ phân')}
                  ...
                  onValueChange={value => {
                    this.props.onSelectDepartmentId(value.id);
                    this.setState({search: ''});
                  }}
                />
              </View>
