...
class ListStudentAttendanceContainer extends React.Component {
    ...
    onLoad() {
        ...
        const lessonID = this.props.classSelected.lesson[0].class_lesson_id;
        this.props.listStudentAttendanceActions
            .loadDataListStudentAttendance(classID, lessonID, this.props.token);
    }
...
function mapStateToProps(state) {
    return {
        ...
        listStudentAttendanceData: state.listStudentAttendance.listStudentAttendanceData,
...
function mapDispatchToProps(dispatch) {
    return {
        listStudentAttendanceActions: bindActionCreators(listStudentAttendanceActions, dispatch)
    };
}

export default connect(mapStateToProps, mapDispatchToProps)(ListStudentAttendanceContainer);