...
class ListStudentPaidContainer extends React.Component {
    ...
    onReload() {
        this.props.listStudentPaidActions
            .loadDataListStudentPaid(this.props.selectedGenId, this.props.selectedBaseId);
    }
...
function mapDispatchToProps(dispatch) {
    return {
        listStudentPaidActions: bindActionCreators(listStudentPaidActions, dispatch)
    };
}

export default connect(mapStateToProps, mapDispatchToProps)(ListStudentPaidContainer);