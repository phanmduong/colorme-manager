                ...
                return (
                    <Container>
                        <View style={styles.container}>
                            <Text
                                style={styles.textError}>{(error) ? alert.LOAD_DATA_ERROR : alert.NO_DATA_STUDENT_LIST}</Text>
                            <Button iconLeft danger small onPress={() => {
                                this.store.searchStudent(this.props.token)
                            }}
            ...
            <Container>
                ...
                >
                    <View style={styles.container}>
                        ...
                        <View style={styles.containerFlex1}>
                            <Text style={styles.textName}>{student.name ? student.name.trim().toUpperCase() : ''}</Text>
