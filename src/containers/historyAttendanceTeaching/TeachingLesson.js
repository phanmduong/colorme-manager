...
class TeachingLesson extends React.Component {
            ...
            <View style={styles.register}>
                ...
                <View style={styles.timeAttendance}>
                    <Text style={styles.textTime}>
                        {lesson.check_in ? lesson.check_in.time : '--:--'}/{lesson.start_time}
                    </Text>
                    <Text style={styles.textTime}>
                        {lesson.check_out ? lesson.check_out.time : '--:--'}/{lesson.end_time}
                    </Text>
                </View>
            </View>
        );
    ...
    getTimeAttendance(lesson) {
        ...
        return calculatorAttendance(checkInTime, checkOutTime, lesson.start_time, lesson.end_time);
    }
    ...
    progressAttendance(data) {
        ...
        return (
            <View style={styles.progressBar}>
                <View style={{...styles.emptyArriveSpan, width: data.empty_arrive_span + '%'}}/>
                <View style={{...styles.earlyArriveSpan, width: data.early_arrive_span + '%'}}/>
                <View style={{...styles.lateArriveSpan, width: data.late_arrive_span + '%'}}/>
                <View style={{...styles.teachingSpan, width: data.teaching_span + '%'}}/>
                <View style={{...styles.earlyLeaveSpan, width: data.early_leave_span + '%'}}/>
                <View style={{...styles.lateLeaveSpan, width: data.late_leave_span + '%'}}/>
            </View>
        )
    }
}
