...
export default function shiftRegisterReducer(
  state = initialState.shiftRegister,
  action,
) {
  switch (action.type) {
    ...
    case types.UPDATE_DATA_SHIFT_REGISTER:
      ...
      shiftRegisterData = changeDataRegister(
        action.shift.id,
        'user',
        action.shift.user,
      );
    ...
    case types.POST_SHIFT_REGISTER:
      ...
      shiftRegisterData = changeDataRegister(
        action.registerId,
        'isLoadingRegister',
        action.isLoadingRegister,
      );
      shiftRegisterData = changeDataRegister(
        action.registerId,
        'isLoadingRegisterError',
        action.isLoadingRegisterError,
      );
      return {
        ...state,
        shiftRegisterData: shiftRegisterData,
    ...
    case types.POST_SHIFT_UNREGISTER:
      ...
      shiftRegisterData = changeDataRegister(
        action.registerId,
        'isLoadingUnRegister',
        action.isLoadingUnRegister,
      );
      shiftRegisterData = changeDataRegister(
        action.registerId,
        'isLoadingUnRegisterError',
        action.isLoadingUnRegisterError,
      );
      return {
        ...state,
        shiftRegisterData: shiftRegisterData,
